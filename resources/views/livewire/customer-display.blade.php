<div class="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-0 sm:p-8" wire:poll.1000ms>
    ...
    @else
        <!-- Header -->
        <div class="w-full max-w-2xl flex flex-col items-center pt-8 pb-2 relative">
            ...
            <div class="flex flex-row items-center gap-2 mb-1">
                <span class="text-base text-gray-500 font-medium">@lang('modules.order.orderNumber') #<span class="font-bold text-gray-800">{{ $orderNumber ?? '--' }}</span></span>
                @if($orderType)
