    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-4 w-fit justify-end">
        ...
        <div class="relative flex items-center">
            <button id="customer-display-dropdown-button" type="button"
                ...
                aria-expanded="false" aria-haspopup="true" data-dropdown-toggle="customer-display-dropdown-menu">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                    <rect x="2" y="4" width="20" height="16" rx="2" ry="2" />
                    <path d="M8 20h8" />
                </svg>
            </button>
            <div id="customer-display-dropdown-menu" class="hidden absolute right-0 z-50 mt-2 w-48 bg-white rounded-md shadow-lg dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
                <ul class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="customer-display-dropdown-button">
                    <li>
                        <a href="/customer-display" target="_blank" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" role="menuitem">
                            <svg class="inline w-4 h-4 mr-2 text-skin-base" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" ry="2" /><path d="M8 20h8" /></svg>
                            Customer Display
                        </a>
                    </li>
