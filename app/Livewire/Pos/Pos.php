...
class Pos extends Component
{
    ...
    public $printDialogOrderId = null;
    public $printDialogKotId = null;
    ...
    public function saveOrder($action, $secondAction = null, $thirdAction = null)
    {
        ...
        if ($status == 'kot') {
            if ($secondAction == 'print') {
                // Show print dialog instead of direct print
                $this->showPrintDialog($order->id, $kot->id);
            }
    ...
    public function printKot($order, $kot = null)
    {
    ...
    public function showPrintDialog($orderId, $kotId)
    {
        $this->printDialogOrderId = $orderId;
        $this->printDialogKotId = $kotId;
        $this->showPrintDialog = true;
    }

    public function closePrintDialog()
    {
        $this->showPrintDialog = false;
        $this->printDialogOrderId = null;
        $this->printDialogKotId = null;
    }

    public function printDirectly()
    {
        if ($this->printDialogKotId) {
            $this->printKot(Order::find($this->printDialogOrderId), Kot::find($this->printDialogKotId));
        }
    ...
    {
        if ($this->printDialogKotId) {
            $url = route('kot.print', [$this->printDialogKotId]);
            $this->dispatch('print_location', $url);
        }
        $this->closePrintDialog();
    }
    ...
    {
        if ($this->printDialogKotId) {
            $url = route('kot.print', [$this->printDialogKotId, 'format' => 'pdf']);
            $this->dispatch('print_location', $url);
        }
        $this->closePrintDialog();
    }
